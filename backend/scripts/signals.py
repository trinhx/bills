...
def main():
    ...
    parser.add_argument("--output", default="backend/data/results/final_signals.csv", help="Path to output CSV")
    args = parser.parse_args()

    logger = setup_logging()
    logger.info("Starting Phase 4 Signal Generation")
    ...
    logger.info(f"Phase 4 Signal Generation completed. Output row count: {output_count}")
